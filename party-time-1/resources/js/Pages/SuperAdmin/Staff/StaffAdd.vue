<template>
    <BreezeAuthenticatedLayout>
        <h1 class="text-center py-12 text-3xl font-bold">Staff Add</h1>
        <div class="flex justify-center">
            <form
                @submit.prevent="submitForm"
                class="md:w-1/3 text-center w-full"
            >
                <BreezeInput
                    id="full_name"
                    type="text"
        ...
        /> -->
                ...
                <div class="relative w-full">
                    ...
                    >
                        ...
                        />
                        <label
                            class="mt-2 rounded px-2 py-1 text-sm text-gray-600 font-mono cursor-pointer js-password-label"
                            for="toggle"
			...
			s12.5,5.597,12.5,12.5C298.521,263.754,263.754,298.521,221.02,298.521z"
                    ...
                    <input
                        class="w-full border-2 shadow mt-2 p-2 text-black border-gray-200"
                        id="password"
                ...
                <button
                    class="rounded-lg mt-6 py-2 px-4 bg-green-700 text-white"
                >
                    Add Staff
                </button>
            </form>
...
export default {
    ...
    methods: {
        submitForm() {
            axios.post("/superadmin/staff/add", this.formData).then((res) => {
                window.location = "/superadmin/staff";
            });
        },
    },
};
