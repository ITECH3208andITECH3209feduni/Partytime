          ...
          <tr class="text-center text-xs" v-for="order in orders" :key="order.id">
            ...
            <td class="p-4">
              <div
                ...
                :key="product_price"
              >
                AUS.{{ product_price * order.products_qtys[index] }}
              </div>
            </td>
            <td class="p-4">AUS.{{ order.products_total }}</td>
            ...
            <td class="p-4 text-white">
              <Link :href="`/staff/change_order_status/` + order.id">
                <button
                  class="bg-yellow-500 py-2 mr-3 px-8 rounded-lg"
                  v-if="order.order_status == 1"
                >
                  Processing
                </button>
                <button
                  class="bg-red-500 py-2 mr-3 px-8 rounded-lg"
                  v-if="order.order_status == 2"
                >
                  Delivered
                </button>
                <button
                  class="bg-gray-600 py-2 mr-3 px-8 rounded-lg disabled:opacity-25"
